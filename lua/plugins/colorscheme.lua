            ...
            config = function()
                require("rose-pine").setup({
                    ...
                    highlight_groups = {
                        ...
                        ["@constant"] = { fg = palette.red_dark },
                        ["@constant.builtin"] = { fg = palette.red_dark },
                        --["@constant.macro"] = {},

                        ["@module"] = { fg = palette.red_dark },
                        ["@module.builtin"] = { fg = palette.red_dark },
                        ["@label"] = { fg = palette.red_dark },
                        ...
                        ["@type"] = { fg = palette.red_dark },
                        ["@type.builtin"] = { fg = palette.red_dark },
                        --["@type.defenition"] = {},

                        ["@function"] = { fg = palette.green_dark },
                        ["@function.builtin"] = { fg = palette.green_dark },
                        ["@function.call"] = { fg = palette.green_dark },
                        ["@function.macro"] = { fg = palette.green_dark },
                        ["@function.method"] = { fg = palette.green_dark },
                        ["@function.method.call"] = { fg = palette.green_dark },
                        ...
                        ["@lsp.type.class"] = { fg = palette.red_dark },
                        ["@lsp.type.decorator"] = { fg = palette.green_dark },
                        ["@lsp.type.enumMember"] = { fg = palette.red_dark },
                        ["@lsp.type.formatSpecifier"] = { fg = palette.purple_dark },
                        ["@lsp.type.function"] = { fg = palette.green_dark },
                        ["@lsp.type.interface"] = { fg = palette.red_dark },
                        ["@lsp.type.macro"] = { fg = palette.green_dark },
                        ["@lsp.type.method"] = { fg = palette.green_dark },
                        ["@lsp.type.modifier"] = { fg = palette.purple_dark },
                        ["@lsp.type.namespace"] = { fg = palette.red_dark },
                        ...
                        ["@lsp.type.struct"] = { fg = palette.red_dark },
